...
CMAKE_OPTS+=" -DCMAKE_VERBOSE_MAKEFILE:BOOL=OFF -DCMAKE_NO_SYSTEM_FROM_IMPORTED=ON -DDEBUG=YES -DCMAKE_BUILD_TYPE=Release -DBUILD_SHARED_LIBS:BOOL=OFF -DINSTALL_GTEST=OFF -DFETCHCONTENT_SOURCE_DIR_GOOGLETEST=$(pwd)/deps/googletest -DFETCHCONTENT_SOURCE_DIR_MAXLIBQT=$(pwd)/deps/maxLibQt"
